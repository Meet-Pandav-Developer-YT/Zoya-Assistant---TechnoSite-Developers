    ...
    <div className="h-[100dvh] w-screen bg-[#050505] text-white flex flex-col items-center justify-between font-sans relative overflow-hidden m-0 p-0">
      ...
      <header className="absolute top-0 left-0 w-full flex justify-between items-center z-20 shrink-0 px-6 py-4 md:px-12 md:py-6">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-violet-500 to-pink-500 flex items-center justify-center font-bold text-[10px]">
            TD
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className={`p-2 rounded-full transition-colors border border-white/10 ${isMuted ? 'bg-red-500/20 text-red-400' : 'bg-white/5 hover:bg-white/10'}`}
      ...
      <footer className="absolute bottom-0 left-0 w-full flex flex-col items-center justify-center pb-6 md:pb-8 z-20 shrink-0 gap-4">
        ...
        <div className="mt-2 text-[10px] md:text-xs text-white/30 font-mono tracking-wider text-center px-4 uppercase">
